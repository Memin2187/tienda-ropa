...
-- CreateEnum
CREATE TYPE "Gender" AS ENUM ('hombres', 'mujeres', 'infantil', 'unisex');

-- CreateEnum
CREATE TYPE "Role" AS ENUM ('admin', 'user');

-- CreateEnum
CREATE TYPE "Colors" AS ENUM ('red', 'blue', 'white', 'black', 'yellow', 'pink', 'green', 'gray', 'orange');
...
CREATE TABLE "Product" (
    ...
    "colors" "Colors"[] DEFAULT ARRAY[]::"Colors"[],
